...
def index_health_check():
    ...
    <head>
        <meta charset="UTF-8">
        <title>WhatsApp AI Mail Bot — Automated Gmail Assistant</title>
    ...
    <body>
        <div class="container">
            <div class="header-card">
                ...
                <h1>WhatsApp AI Mail Bot</h1>
                <div class="tagline">Official Meta Enterprise Cloud Webhook Ready</div>
                <p class="desc">
                    Send documents, notes, or voice messages via WhatsApp to automatically analyze content, draft professional emails via Gemini AI, and send them seamlessly through Gmail.
                </p>
                <div class="btn-group">
                    <a href="/mailbot?phone=%2B916305970096" class="btn">🔑 Authorize Gmail Account</a>
                    <a href="/static/uploads/WhatsApp_Mail_Bot_AI_User_Manual.pdf" class="btn btn-secondary" target="_blank">📘 Download User Manual</a>
                </div>
                <br>
                <div class="status-badge">
                    <span class="status-dot"></span> 24/7 Cloud Service Active • Meta API Endpoint Online
                </div>
            </div>

            <div class="features-grid">
                <div class="feature-card">
                    <h3>⚡ Instant Document Processing</h3>
                    <p>Send PDF, DOCX, or text files on WhatsApp. AI automatically extracts key points and builds polished email drafts.</p>
                </div>
                <div class="feature-card">
                    <h3>💬 Approval & Send Cards</h3>
                    <p>Receive interactive WhatsApp confirmation cards to approve, edit recipient email, or send drafts instantly.</p>
                </div>
                <div class="feature-card">
                    <h3>🔒 Secure OAuth2 Authentication</h3>
                    <p>Connect your personal or business Gmail account securely using Google OAuth2 credentials.</p>
                </div>
                <div class="feature-card">
                    <h3>🌐 24/7 Enterprise Uptime</h3>
                    <p>Powered by Official Meta WhatsApp Cloud API webhooks with 100% cloud reliability and 0.01s latency.</p>
                </div>
            </div>

            <footer>
                <p>Dedicated Bot Phone: <b>+91 63059 70096</b> | Meta Webhook: <code>/webhook</code></p>
            </footer>
        </div>
    </body>
    </html>
